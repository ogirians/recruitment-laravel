     ...
     <div class="col">
       ...
       <input class="form-control" id="datepicker" placeholder="tanggal" type="date" name="tanggal" required="required" value="{{ old('tanggal') }}"> <br/>
        ...
        <label for="exampleFormControlSelect1">Pendidikan Terakhir</label>
          <select class="form-control" id="exampleFormControlSelect1" name="pendidikan" required="required" value="{{ old('pendidikan') }}">
          <option>SMA</option>
          <option>SMK</option>
          <option>S1</option>
          <option>S2</option>
        ...
        <input class="form-control" id="exampleFormControlInput1" placeholder="Teknik Perkapalan" type="text" name="jurusan" required="required" value="{{ old('jurusan') }}"><br/>
