...
<head>
  ...
  <!-- Custom CSS -->
  <link href="kuning/css/stylish-portfolio.min.css" rel="stylesheet">
  ...
  <header class="masthead d-flex">
    <div class="container">
      <div class="text-center">
          <div class="row">
            <div class="col"></div>
            <div class="col" max-widht="100px" max- height="100px"><img width="100px" height="85px" src="kuning/img/logo_ibi.png"></div>
            <div class="col"></div>
          </div>
      <h3 class="mb-2">
